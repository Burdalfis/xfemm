...
-- ============================================================
-- XFEMM / FEMMCLI SINGLE-SOLVE BENCHMARK
-- ============================================================
-- No Windows paths. No worker sharding. One no-load solution only.
-- ============================================================

bench_angle = 2.5

-- Explicitly zero all terminal phase/circuit currents.
mi_modifycircprop("A", 1, 0)
mi_modifycircprop("B", 1, 0)
mi_modifycircprop("C", 1, 0)

-- Match the outer-rotor sliding-band motion convention used by the
-- production FEMM scripts.
mi_modifyboundprop("SlidingBand", 11, bench_angle)

mi_saveas("xfemm_benchmark_geprc_speedx2_1404_4600kv.fem")

print("BENCHMARK_BEGIN")
print("MOTOR,GEPRC SpeedX2 1404 4600KV")
print("ANGLE_MECH_DEG," .. bench_angle)
print("BAND_SEGMENT_DEG,0.5")
print("AIRGAP_MM," .. airgap)

-- The Wine/FEMM production runner calls mi_smartmesh(0). femmcli does not
-- expose that switch. Important local mesh constraints and SlidingBand arc
-- segmentation are already explicit in this model.  Do not call
-- mi_createmesh() separately under XFEMM; mi_analyze() creates the mesh.
mi_analyze(1)
mi_loadsolution()
...
print("RESULT_TORQUE_NM," .. T)
print("RESULT_TORQUE_MNM," .. (T*1000))
print("RESULT_LAMBDA_A_WBTURN," .. lambdaA)
print("RESULT_LAMBDA_B_WBTURN," .. lambdaB)
print("RESULT_LAMBDA_C_WBTURN," .. lambdaC)
print("RESULT_ELEMENTS," .. nelem)
print("RESULT_NODES," .. nnode)
print("BENCHMARK_END")
